...
The pattern is the same as for invocation recognizers: every access is dispatched to every recognizer, and the recognizer returns `null` for accesses it doesn't claim.
