...
Two of the five shapes, **schema** and **spec**, ship today across HTTP, GraphQL, AppSync, message-bus, storage, and component domains. `suss contract --from <source>` takes seven values, from six reader packages:
