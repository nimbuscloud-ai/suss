...
<svg class="suss-diagram" viewBox="0 0 660 520" role="img" aria-labelledby="layers-title layers-desc">
  ...
  <text class="note" x="330" y="260" text-anchor="middle">167 rules. 17 of them derive stepsTo(x, y, kind): one hop from a value to a value.</text>
...
`packages/resolution/src/index.ts` contains 167 rules and no code.
