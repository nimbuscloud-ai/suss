...
The longer working-out of the Jackson mapping, including the failure modes of deriving concepts from code and what an intent specification looks like under it, is a design record rather than documentation: see [the backlog](https://github.com/nimbuscloud-ai/suss/blob/main/design/backlog.md).
