...
Phases 1–6 complete. Full extraction pipeline with cross-boundary checking: IR, extractor, TypeScript adapter, three framework packs (ts-rest, React Router, Express), `fetch` runtime pack, pairwise checker, CLI, consumer-side discovery, and fixture sets. 519 tests. See [`docs/status.md`](docs/status.md) for details.
