...
- [`docs/behavioral-summary-format.md`](docs/behavioral-summary-format.md) — the summary format spec, JSON Schema, consumption guide, what you can build on this
...
Phases 1–7 complete. Full extraction pipeline with cross-boundary checking: IR, extractor, TypeScript adapter, three pattern packs (ts-rest, React Router, Express), `fetch` runtime pack, pairwise checker with automatic boundary pairing, CLI, consumer-side discovery, response property semantics, and fixture sets. 603 tests. See [`docs/status.md`](docs/status.md) for details.
