...
The reference for `@suss/datalog`: what it does to stay quick, how a derivation is tagged, and how a caller asks for one answer. The [README](./README.md) says what the package is for.
