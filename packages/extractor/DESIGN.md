...
The reference for `@suss/extractor`: how wrappers fold into a unit, which branch an effect belongs to, and how the extraction cache decides what to reuse. The [README](./README.md) says what the package is for.
