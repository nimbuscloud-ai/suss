# How the Terraform reader resolves a reference

The reference for `@suss/contract-terraform`: the references it follows through a configuration, and the ones it leaves as written. The [README](./README.md) says what the package is for.
