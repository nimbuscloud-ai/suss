...
- `storagePairing.ts:makeFieldUnknownFinding` generates the per-field errors for code that touches undeclared columns.
- `storagePairing.ts:makeFieldUnusedFinding` generates the warning for schema columns no code accesses.
