...
We are committed to providing a welcoming and respectful environment for everyone contributing to or participating in this project, regardless of background or experience level.

## Standards

Contributors are expected to act professionally and constructively. Behavior that is hostile, demeaning, or that disrupts the work of others is not acceptable.
...
Adapted from the [Contributor Covenant](https://www.contributor-covenant.org/), version 2.1. The full text is available at the link above.
