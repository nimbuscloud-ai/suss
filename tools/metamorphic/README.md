...
- **What the discovered unit reaches**, by walking the calls the run
  recorded from the unit and collecting the boundary accesses on every
  function it comes to. This is what says the unit is connected to the
